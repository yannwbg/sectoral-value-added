...
#Load original data
files_list <- list.files(path = "data/raw/global", pattern = "3_current", full.names = TRUE)
...
write_csv(data, "data/temp/un3_current.csv")
write_csv(footnote, "data/temp/un3_current_footnote.csv")
write_csv(sector, "data/temp/un3_sector.csv")
